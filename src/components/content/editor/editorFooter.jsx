...
class EditorFooter extends Component {
  ...
  renderRunStatus = () => {
    ...
    return (
      <span
        id="run_status"
        style={{ fontWeight: 500, fontSize: "1.5rem", color: color }}
      >
    ...
    if (this.state.run_time)
      return (
        <div style={{ margin: "0 0 10px 25px" }}>
          Run Time: {this.state.run_time} ms
        </div>
      );
  };
          ...
          >
            <div className="container text-center">
              <div className="row" style={{ margin: "20px 0 10px 0" }}>
                ...
                <div className="col-md-4" style={{ textAlign: "right" }}>
                  <button
                    className="btn btn-outline-primary me-md-4"
                    type="button"
                    style={{ width: "6rem", borderRadius: "25px" }}
                  >
                    Debug
                  </button>
                  <button
            ...
            <div style={{ margin: "0 25px" }}>
              ...
              <textarea
                ...
                id="input"
                rows={this.state.input_rows}
                onChange={this.updateInputHeight}
              ></textarea>
            </div>

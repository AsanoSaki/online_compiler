...
const COMPLETIONS = {
  cpp: [
    ...
    { label: "algorithm", type: "keyword" },
    { label: "deque", type: "keyword" },
    { label: "string", type: "keyword" },
    { label: "map", type: "keyword" },
    { label: "vector", type: "keyword" },
    { label: "set", type: "keyword" },
    { label: "unordered_set", type: "keyword" },
    { label: "unordered_map", type: "keyword" },
    { label: "cstring", type: "keyword" },
    { label: "cmath", type: "keyword" },
    { label: "numeric", type: "keyword" },
    { label: "cstdio", type: "keyword" },
    { label: "cstdlib", type: "keyword" },
    { label: "list", type: "keyword" },
